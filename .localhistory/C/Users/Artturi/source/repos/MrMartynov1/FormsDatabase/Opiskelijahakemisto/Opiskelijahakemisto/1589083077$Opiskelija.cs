...
namespace Opiskelijahakemisto
{
    ...
    public class Kurssi
    {
        ...
        public string KrListInfo
        {
            get
            {
                return $"{ Nimi }, ({ KurssiID })";
            }
        }
    }
    ...
    public class Koe
    {
        ...
        public int OpiskelijaV { get; set; }
        public int ProsenttiMaaraV { get; set; }
        public int KoeV { get; set; }

        public string KoeListInfo
        {
            get
            {
                return $"{ Koenimi }, { Kieli }, { Opettaja }, { Pvm } ({ KoeID })";
            }
        }
    }
    ...
    public class MaxIdOp
    {
        public int maxidop { get; set; }
    }

    public class MaxIdKr
    {
        public int maxidkr { get; set; }
    }

    public class MaxIdKoe
    {
        public int maxidkoe { get; set; }
    }
}
