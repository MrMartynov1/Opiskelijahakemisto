...
namespace Opiskelijahakemisto
{
    public partial class OpListForm : Form
    {
        ...
        public void btnVal_Click(object sender, EventArgs e)
        {
            ...
            {
                SelectedId = ((Opiskelijahakemisto.Kurssi)lsbOp.SelectedItem).Etunimi;
                SelectedOpiskelija = (Opiskelijahakemisto.Kurssi)lsbOp.SelectedItem;
                this.Close();
            }
            else
            {
