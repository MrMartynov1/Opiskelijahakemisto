...
namespace Opiskelijahakemisto
{
    public partial class Form1 : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            else if (lbOpID.Text == null & lbKrID.Text == null)
            {
                try
                {
                    int.TryParse(lbOpID.Text, out opidint);
            ...
            else if (lbOpID.Text == null & lbKrID.Text == null & lbKoID.Text == null)
            {
                try
                {
                    int.TryParse(lbOpID.Text, out opidint);
            ...
            else if (lbOpID.Text == null & lbKrID.Text == null & lbKoID.Text == null & lbVID.Text == null)
            {
                try
                {
                    int.TryParse(lbOpID.Text, out opidint);
            ...
            else if (lbKoID.Text == null & lbVID.Text == null)
            {
                try
                {
                    int.TryParse(lbKoID.Text, out koidint);
            ...
            //MORE FOR UPDATING
            else if (/*Something & */ (tbEtunimi.Text != OrgEN & OrgEN!=null) | (tbSukunimi.Text != OrgSN) | (tbHloT.Text != OrgHLT) | (tbMaa.Text != OrgM) | (tbOsoite.Text != OrgOS) | (tbPostnum.Text != OrgPST) | (tbKunta.Text != OrgKU) | (tbSaPo.Text != OrgSP) | (tbSite.Text != OrgST) | (tbPuh.Text != OrgPH1) | (tbPuh2.Text != OrgPH2) | (tbYritys.Text != OrgYR) | (tbThNim.Text != OrgTHN) | (tbMuu.Text != OrgMU))
            {
                //lbOpID.Text = TOVar;
                //OpListForm opListForm = new OpListForm(Opiskelijat, SukuVar, idChecker, Alt);
