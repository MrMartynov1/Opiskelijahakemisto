...
namespace Opiskelijahakemisto
{
    public partial class Form1 : Form
    {
        ...
        //
        public List<Kurssi> Opiskelijat = new List<Kurssi>();
        ...
        public void populateForm(Kurssi opiskelija)
        {
        ...
        private void btnHakuKur_Click(object sender, EventArgs e)
        {
            ...
            {
                tbOp.Text = SukuVar;
                KrListForm opListForm = new KrListForm(Opiskelijat, SukuVar, idChecker, Alt);
                SukuVar = opListForm.SukuVar;
                opListForm.ShowDialog();
                this.Show();
                try
