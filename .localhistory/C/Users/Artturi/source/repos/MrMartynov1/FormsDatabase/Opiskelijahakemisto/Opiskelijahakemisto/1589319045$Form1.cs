...
namespace Opiskelijahakemisto
{
    public partial class Form1 : Form
    {
        ...
        private void btnKoeU_Click(object sender, EventArgs e)
        {
            ...
            btndelet.Enabled = false;
            //
            if (tbKoeNimi.Text != null & tbOpett.Text != null & tbVaik.Text != null & tbKieli.Text != null & tbPvm.Text != "" & tbTPO.Text!= null & tbSPO.Text != null)
            {
                btnSave.Enabled = true;
            }
            else
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            else if (lbOpID == null & lbKrID == null)
            {
                try
                {
                    int.TryParse(lbOpID.Text, out opidint);
            ...
            else if (lbOpID == null & lbKrID == null & lbKoID == null)
            {
                try
                {
                    int.TryParse(lbOpID.Text, out opidint);
            ...
            else if (lbOpID == null & lbKrID == null & lbKoID == null & lbVID == null)
            {
                try
                {
                    int.TryParse(lbOpID.Text, out opidint);
            ...
            else if (lbKoID == null & lbVID == null)
            {
                try
                {
                    int.TryParse(lbKoID.Text, out koidint);
            ...
            //MORE FOR UPDATING?
            //else if tbSomething != OrgX -> as previously only different stored procedures
            else if (/*Something & */ tbEtunimi.Text != OrgEN | tbSukunimi.Text != OrgSN | tbHloT.Text != OrgHLT | tbMaa.Text != OrgM | tbOsoite.Text != OrgOS | tbPostnum.Text != OrgPST | tbKunta.Text != OrgKU | tbSaPo.Text != OrgSP | tbSite.Text != OrgST | tbPuh.Text != OrgPH1 | tbPuh2.Text != OrgPH2 | tbYritys.Text != OrgYR | tbThNim.Text != OrgTHN | tbMuu.Text != OrgMU)
            {
                try
                {
                    int.TryParse(lbOpID.Text, out opidint);
            ...
            else if (/*Something & */ tbKrNimi.Text != OrgN)
            {
                try
                {
                    int.TryParse(lbKrID.Text, out kridint1);
            ...
            else if (/*Something & */ tbKoeNimi.Text != OrgKN | tbKieli.Text != OrgKl | tbVaik.Text != OrgVk | tbOpett.Text != OrgOp | tbTPO.Text != OrgTPO | tbPvm.Text != OrgPvm)
            {
                try
                {
                    int.TryParse(lbKoID.Text, out koidint);
            ...
            else if (/*Something & */ tbSPO.Text != OrgSPO)
            {
                try
                {
                    int.TryParse(lbVID.Text, out vtidint);
            ...
            else if (/*Something & */ (tbEtunimi.Text != OrgEN | tbSukunimi.Text != OrgSN | tbHloT.Text != OrgHLT | tbMaa.Text != OrgM | tbOsoite.Text != OrgOS | tbPostnum.Text != OrgPST | tbKunta.Text != OrgKU | tbSaPo.Text != OrgSP | tbSite.Text != OrgST | tbPuh.Text != OrgPH1 | tbPuh2.Text != OrgPH2 | tbYritys.Text != OrgYR | tbThNim.Text != OrgTHN | tbMuu.Text != OrgMU) & (tbKrNimi.Text != OrgN))
            {
                try
                {
                    int.TryParse(lbOpID.Text, out opidint);
            ...
            else if (/*Something & */ (tbKoeNimi.Text != OrgKN | tbKieli.Text != OrgKl | tbVaik.Text != OrgVk | tbOpett.Text != OrgOp | tbTPO.Text != OrgTPO | tbPvm.Text != OrgPvm) & (tbSPO.Text != OrgSPO))
            {
                tbKoe.Text = KoeVar;
                KoeListForm koeListForm = new KoeListForm(Kokeet, KoeVar, KoeidC, KoeAlt);
                KoeVar = koeListForm.KoeVar;
        ...
        {
            //REPLACE WITH THING BASED ON ID
            //SelectedOpiskelija = (Opiskelijahakemisto.Opiskelija);
            Opiskelija nextid = db.GetNextOp(1);
