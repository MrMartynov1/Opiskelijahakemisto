...
namespace Opiskelijahakemisto
{
    public partial class Form1 : Form
    {
        ...
        {
            if (lbOpID.Text == null & (tbEtunimi.Text != OrgEN | tbSukunimi.Text != OrgSN | tbHloT.Text != OrgHLT | tbMaa.Text != OrgM | tbOsoite.Text != OrgOS | tbPostnum.Text != OrgPST | tbKunta.Text != OrgKU | tbSaPo.Text != OrgSP | tbSite.Text != OrgST | tbPuh.Text != OrgPH1 | tbPuh2.Text != OrgPH2 | tbYritys.Text != OrgYR | tbThNim.Text != OrgTHN | tbMuu.Text != OrgMU))
            {
                try
                {
            ...
            else if (lbKrID.Text == null & tbKrNimi.Text != OrgN)
            {
                try
                {
            ...
            else if (lbKoID.Text == null & (tbKoeNimi.Text != OrgKN | tbKieli.Text != OrgKl | tbVaik.Text != OrgVk | tbOpett.Text != OrgOp | tbTPO.Text != OrgTPO | tbPvm.Text != OrgPvm))
            {
                try
                {
            ...
            else if (lbVID.Text == null & tbSPO.Text != OrgSPO)
            {
                try
                {
            ...
            else if ((lbOpID.Text == null & (tbEtunimi.Text != OrgEN | tbSukunimi.Text != OrgSN | tbHloT.Text != OrgHLT | tbMaa.Text != OrgM | tbOsoite.Text != OrgOS | tbPostnum.Text != OrgPST | tbKunta.Text != OrgKU | tbSaPo.Text != OrgSP | tbSite.Text != OrgST | tbPuh.Text != OrgPH1 | tbPuh2.Text != OrgPH2 | tbYritys.Text != OrgYR | tbThNim.Text != OrgTHN | tbMuu.Text != OrgMU)) & (lbKrID.Text == null & tbKrNimi.Text != OrgN) & (lbKoID.Text == null & (tbKoeNimi.Text != OrgKN | tbKieli.Text != OrgKl | tbVaik.Text != OrgVk | tbOpett.Text != OrgOp | tbTPO.Text != OrgTPO | tbPvm.Text != OrgPvm)))
            {
                try
                {
                    int.TryParse(lbOpID.Text, out opidint);
            ...
            else if ((lbOpID.Text == null & (tbEtunimi.Text != OrgEN | tbSukunimi.Text != OrgSN | tbHloT.Text != OrgHLT | tbMaa.Text != OrgM | tbOsoite.Text != OrgOS | tbPostnum.Text != OrgPST | tbKunta.Text != OrgKU | tbSaPo.Text != OrgSP | tbSite.Text != OrgST | tbPuh.Text != OrgPH1 | tbPuh2.Text != OrgPH2 | tbYritys.Text != OrgYR | tbThNim.Text != OrgTHN | tbMuu.Text != OrgMU)) & (lbKrID.Text == null & tbKrNimi.Text != OrgN) & (lbKoID.Text == null & (tbKoeNimi.Text != OrgKN | tbKieli.Text != OrgKl | tbVaik.Text != OrgVk | tbOpett.Text != OrgOp | tbTPO.Text != OrgTPO | tbPvm.Text != OrgPvm)) & (lbVID.Text == null & tbSPO.Text != OrgSPO))
            {
                try
                {
                    int.TryParse(lbOpID.Text, out opidint);
            ...
            else if ((lbKoID.Text == null & (tbKoeNimi.Text != OrgKN | tbKieli.Text != OrgKl | tbVaik.Text != OrgVk | tbOpett.Text != OrgOp | tbTPO.Text != OrgTPO | tbPvm.Text != OrgPvm)) & (lbVID.Text == null & tbSPO.Text != OrgSPO))
            {
                try
                {
                    int.TryParse(lbKoID.Text, out koidint);
            ...
            //MORE FOR UPDATING
            else if ((tbEtunimi.Text != OrgEN & OrgEN!=null) | (tbSukunimi.Text != OrgSN & OrgSN != null) | (tbHloT.Text != OrgHLT & OrgHLT != null) | (tbMaa.Text != OrgM & OrgM != null) | (tbOsoite.Text != OrgOS & OrgOS != null) | (tbPostnum.Text != OrgPST & OrgPST != null) | (tbKunta.Text != OrgKU & OrgKU != null) | (tbSaPo.Text != OrgSP & OrgSP != null) | (tbSite.Text != OrgST & OrgST != null) | (tbPuh.Text != OrgPH1 & OrgPH1 != null) | (tbPuh2.Text != OrgPH2 & OrgPH2 != null) | (tbYritys.Text != OrgYR & OrgYR != null) | (tbThNim.Text != OrgTHN & OrgTHN != null) | (tbMuu.Text != OrgMU & OrgMU != null))
            {
                //lbOpID.Text = TOVar;
                //OpListForm opListForm = new OpListForm(Opiskelijat, SukuVar, idChecker, Alt);
            ...
            else if ((tbEtunimi.Text != OrgEN | tbSukunimi.Text != OrgSN | tbHloT.Text != OrgHLT | tbMaa.Text != OrgM | tbOsoite.Text != OrgOS | tbPostnum.Text != OrgPST | tbKunta.Text != OrgKU | tbSaPo.Text != OrgSP | tbSite.Text != OrgST | tbPuh.Text != OrgPH1 | tbPuh2.Text != OrgPH2 | tbYritys.Text != OrgYR | tbThNim.Text != OrgTHN | tbMuu.Text != OrgMU) & (tbKrNimi.Text != OrgN))
            {
            ...
            else if ((tbEtunimi.Text != OrgEN | tbSukunimi.Text != OrgSN | tbHloT.Text != OrgHLT | tbMaa.Text != OrgM | tbOsoite.Text != OrgOS | tbPostnum.Text != OrgPST | tbKunta.Text != OrgKU | tbSaPo.Text != OrgSP | tbSite.Text != OrgST | tbPuh.Text != OrgPH1 | tbPuh2.Text != OrgPH2 | tbYritys.Text != OrgYR | tbThNim.Text != OrgTHN | tbMuu.Text != OrgMU) & (tbKrNimi.Text != OrgN) & (tbKoeNimi.Text != OrgKN | tbKieli.Text != OrgKl | tbVaik.Text != OrgVk | tbOpett.Text != OrgOp | tbTPO.Text != OrgTPO | tbPvm.Text != OrgPvm))
            {
                //tbEtunimi.Text = SukuVar;
                //OpListForm opListForm = new OpListForm(Opiskelijat, SukuVar, idChecker, Alt);
                //SukuVar = opListForm.SukuVar;
            ...
            else if ((tbEtunimi.Text != OrgEN | tbSukunimi.Text != OrgSN | tbHloT.Text != OrgHLT | tbMaa.Text != OrgM | tbOsoite.Text != OrgOS | tbPostnum.Text != OrgPST | tbKunta.Text != OrgKU | tbSaPo.Text != OrgSP | tbSite.Text != OrgST | tbPuh.Text != OrgPH1 | tbPuh2.Text != OrgPH2 | tbYritys.Text != OrgYR | tbThNim.Text != OrgTHN | tbMuu.Text != OrgMU) & (tbKrNimi.Text != OrgN) & (tbKoeNimi.Text != OrgKN | tbKieli.Text != OrgKl | tbVaik.Text != OrgVk | tbOpett.Text != OrgOp | tbTPO.Text != OrgTPO | tbPvm.Text != OrgPvm) & (tbSPO.Text != OrgSPO))
            {
                //tbEtunimi.Text = SukuVar;
                //OpListForm opListForm = new OpListForm(Opiskelijat, SukuVar, idChecker, Alt);
                //SukuVar = opListForm.SukuVar;
            ...
            else if ((tbKoeNimi.Text != OrgKN | tbKieli.Text != OrgKl | tbVaik.Text != OrgVk | tbOpett.Text != OrgOp | tbTPO.Text != OrgTPO | tbPvm.Text != OrgPvm) & (tbSPO.Text != OrgSPO))
            {
                tbKoe.Text = KoeVar;
                KoeListForm koeListForm = new KoeListForm(Kokeet, KoeVar, KoeidC, KoeAlt);
                KoeVar = koeListForm.KoeVar;
