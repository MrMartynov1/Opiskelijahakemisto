...
namespace Opiskelijahakemisto
{
    public class DataAccess
    {
        ...
        public int LisaaOpiskelija (int opid, string etunimi, string sukunimi, string hlotunnus, string yritys, string thnimike, string sposti, string osoite, string kaupunki, int postnum, string maa, string puh, string puh2, string site, string muuta)
        {
            using (IDbConnection connection = new System.Data.SqlClient.SqlConnection(Connecc.ConnValue("KoulutusTK")))
            {
               ...
               // p.Add("@OpID", opid);
                p.Add("@new_identity", dbType: DbType.Int32, direction: ParameterDirection.ReturnValue);            
                p.Add("@Etunimi", etunimi);
                p.Add("@Sukunimi", sukunimi);
                p.Add("@Hlotunnus", hlotunnus);
                p.Add("@Yritys", yritys);
                p.Add("@Thnimike", thnimike);
                p.Add("@Sposti", sposti);
                p.Add("@Osoite", osoite);
                p.Add("@Kaupunki", kaupunki);
                p.Add("@Postnum", postnum);
                p.Add("@Maa", maa);
                p.Add("@Puh", puh);
                p.Add("@Puh2", puh2);
                p.Add("@Site", site);
                ...
                var result = connection.Execute("dbo.Koulutus_Insert", p, commandType: CommandType.StoredProcedure);
                var rrr = p.Get<int>("@new_identity");
                return rrr;
            }
       
        }

        public int LisaaKurssi(int krid, string krnimi)
        {
            using (IDbConnection connection = new System.Data.SqlClient.SqlConnection(Connecc.ConnValue("KoulutusTK")))
            {
                ...
                var result = connection.Execute("dbo.Kurssi_Insert", p, commandType: CommandType.StoredProcedure);
                var rrr = p.Get<int>("@new_identity");
                return rrr;
            }
        }

        public int LisaaKoe(int koeid, string koenimi, string kieli, int vaikeus, int krid, string ope, int pto, string pvm)
        {
            using (IDbConnection connection = new System.Data.SqlClient.SqlConnection(Connecc.ConnValue("KoulutusTK")))
            {
                ...
                var p = new DynamicParameters();
                p.Add("@new_identity", dbType: DbType.Int32, direction: ParameterDirection.ReturnValue);
                p.Add("@Koenimi", koenimi);
                p.Add("@Kieli", kieli);
                p.Add("@Vaikeus", vaikeus);
                p.Add("@KurssiID", krid);//
                p.Add("@Opettaja", ope);
                p.Add("@Prosenttitavoite", pto);
                p.Add("@Pvm", pvm);

                var result = connection.Execute("dbo.Koe_Insert", p, commandType: CommandType.StoredProcedure);
                var rrr = p.Get<int>("@new_identity");
                return rrr;
            }
        }

        public int LisaaTulos(int vtid, int opid, int pso, int koeid)
        {
            using (IDbConnection connection = new System.Data.SqlClient.SqlConnection(Connecc.ConnValue("KoulutusTK")))
            {
                ...
                var p = new DynamicParameters();
                p.Add("@new_identity", dbType: DbType.Int32, direction: ParameterDirection.ReturnValue);
                p.Add("@Opiskelija", opid);
                p.Add("@ProsenttiMaara", pso);
                p.Add("@Koe", koeid);

                var result = connection.Execute("dbo.Vastaus_Insert", p, commandType: CommandType.StoredProcedure);
                var rrr = p.Get<int>("@new_identity");
                return rrr;
            }
        }
        ...
        public void PaivitaKoe(int koeid, string koenimi, string kieli, int vaikeus, int krid, string ope, int pto, string pvm)
        {
            using (IDbConnection connection = new System.Data.SqlClient.SqlConnection(Connecc.ConnValue("KoulutusTK")))
            {
                ...
                */
                connection.Execute("dbo.Koe_Update @KoeID, @Koenimi, @Kieli, @Vaikeus, @KurssiID, @Opettaja, @Prosenttitavoite, @Pvm",
                new { KoeID = koeid, Koenimi = koenimi, Kieli = kieli, Vaikeus = vaikeus, KurssiID = krid, Opettaja = ope, Prosenttitavoite = pto, Pvm = pvm });
        ...
        public void PoistaOpiskelija(int opid)
        {
            using (IDbConnection connection = new System.Data.SqlClient.SqlConnection(Connecc.ConnValue("KoulutusTK")))
            {
                List<Opiskelija> opiskelijat = new List<Opiskelija>();//NOT NEEDED PROBS
        ...
        public void PoistaKurssi(int krid)
        {
            using (IDbConnection connection = new System.Data.SqlClient.SqlConnection(Connecc.ConnValue("KoulutusTK")))
            {
                List<Kurssi> kurssit = new List<Kurssi>();//NOT NEEDED PROBS
        ...
        public void PoistaKoe(int koeid)
        {
            using (IDbConnection connection = new System.Data.SqlClient.SqlConnection(Connecc.ConnValue("KoulutusTK")))
            {
                List<Koe> kokeet = new List<Koe>();//NOT NEEDED PROBS
